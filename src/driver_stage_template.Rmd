...
```{r driver_rebased_gap_{{result_group}}_{{stage_code}}_{{driverCode}}, echo=FALSE, message=FALSE, error=FALSE, results='asis', cache=TRUE}
#driverCode="KAT"
...
```{r driver_rebased_gap_{{result_group}}_{{stage_code}}_{{driverCode}}_table, cache=TRUE}
if (!driver_blank){
