...
```{r driver_rebased_gap-{{result_group}}-{{stage_code}}-{{driverCode}}, echo=FALSE, message=FALSE, error=FALSE, results='asis', cache=TRUE}
#driverCode="KAT"
...
```{r driver_rebased_gap-{{result_group}}-{{stage_code}}-{{driverCode}}-table, cache=TRUE}
if (!driver_blank){
